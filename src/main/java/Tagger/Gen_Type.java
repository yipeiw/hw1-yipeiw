 ...
 * @generated */
public class Gen_Type extends Annotation_Type {
  /** @generated */
  @Override
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (Gen_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = Gen_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new Gen(addr, Gen_Type.this);
  			   Gen_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new Gen(addr, Gen_Type.this);
  	  }
    };
  /** @generated */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = Gen.typeIndexID;
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("Tagger.Gen");
  ...
  public String getSentenceID(int addr) {
      ...
      jcas.throwFeatMissing("sentenceID", "Tagger.Gen");
  ...
  public String getSource(int addr) {
      ...
      jcas.throwFeatMissing("source", "Tagger.Gen");
  ...
  public float getConfidence(int addr) {
      ...
      jcas.throwFeatMissing("confidence", "Tagger.Gen");
  ...
  public int getStartOffset(int addr) {
      ...
      jcas.throwFeatMissing("StartOffset", "Tagger.Gen");
  ...
  /** initialize variables to correspond with Cas Type and Features
	* @generated */
  public Gen_Type(JCas jcas, Type casType) {
    super(jcas, casType);
